...
module Apartment
  ...
  class << self
    ...
    WRITER_METHODS    = [:rsapi_db_config_getter, :tenant_names, :database_structure_file, :database_schema_file, :excluded_models, :default_schema, :persistent_schemas, :connection_class, :tld_length, :db_migrate_tenants, :seed_data_file]
